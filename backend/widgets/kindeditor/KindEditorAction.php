...
use backend\widgets\kindeditor\Services_JSON;
...
class KindEditorAction extends Action {
    ...
    public function init() {
        ...
        if(Yii::$app->request->get('toback',0)){
            ...
            $this->php_url =  Yii::$app->urlManager->hostInfo.Yii::getAlias("@web/");
            /*如果要存到后台*/
        }
        else{
            $this->php_path =  str_replace("backend","frontend",Yii::getAlias("@webroot/"));
            $this->php_url =  Yii::$app->furlManager->hostInfo.Yii::$app->furlManager->baseUrl."/";
        }
